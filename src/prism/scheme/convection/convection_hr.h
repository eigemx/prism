...
auto phiAtDummyUpwind(Field& field, const mesh::Cell& cell, const mesh::Cell& downwind) -> double;

template <field::IScalarBased Field>
auto phiTilde(Field& field, const mesh::Cell& cell, const mesh::Cell& downwind) -> double;


template <field::IScalarBased Field>
auto phiAtDummyUpwind(Field& field, const mesh::Cell& cell, const mesh::Cell& downwind)
    -> double {
