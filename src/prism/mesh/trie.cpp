...
void FacesLookupTrie::add(const std::vector<std::size_t>& face_labels, std::size_t face_id) {
...
auto FacesLookupTrie::contains(const std::vector<std::size_t>& face_labels) const
